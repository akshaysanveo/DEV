    ...
    function createStyleSheet(defaultFont) {
        ...
        var oStyles = {
            add: function (a) {
                ...
                if (a.border) style.border = 1 + findOrAdd(borders, normalizeBorders(a.border.toString().trim()));
                // There is a HARDCODED border
    ...
    function generateColums(columns) {
        ...
        for (var i = 0; i < columns.length; i++) {
            ...
            if (c) {
                ...
                if (c.wt == "auto") s = s + ' width="50" bestFit="1" customWidth="1" '; else if (c.wt) s = s + ' width="' + c.wt + '" customWidth="1" ';
